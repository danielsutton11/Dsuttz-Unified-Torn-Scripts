...
// @run-at       document-end
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/XXXXX/DSS%3A%20Torn%20Cash%20Monitor.user.js
// @updateURL https://update.greasyfork.org/scripts/XXXXX/DSS%3A%20Torn%20Cash%20Monitor.meta.js
// ==/UserScript==
...
(function() {
    ...
    // Configuration
    const CASH_THRESHOLD = 10000000; // $10M default - adjust as needed
    const CHECK_INTERVAL = 1000; // Check every 1 seconds
    ...
    function updateCheck() {
        ...
        // Show alert if cash is over threshold AND cooldown has passed
    ...
    function handleVaultClick() {
        ...
        // Set alert timestamp to prevent re-showing on new page
    ...
    function closeCashAlert() {
        ...
        // Also set timestamp when manually closing
        sessionStorage.setItem('lastCashAlertTime', Date.now().toString());
    }
